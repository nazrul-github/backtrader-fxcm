...
class MetafxcmBroker(BrokerBase.__class__):
    def __init__(self, name, bases, dct):
        '''Class has already been created ... register'''
        # Initialize the class
        super(MetafxcmBroker, self).__init__(name, bases, dct)
        fxcmstore.fxcmStore.BrokerCls = self


class fxcmBroker(with_metaclass(MetafxcmBroker, BrokerBase)):
    '''Broker implementation for fxcm.
    This class maps the orders/positions from fxcm to the
    ...
    def __init__(self, **kwargs):
        super(fxcmBroker, self).__init__()
        self.o = fxcmstore.fxcmStore(**kwargs)
    ...
    def stop(self):
        super(fxcmBroker, self).stop()
        self.o.stop()

    def getcash(self):
        # This call cannot block if no answer is available from fxcm
